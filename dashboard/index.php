    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <img
                    style="width:100%; height:100%;background-image:url('../images/back.jpg'); background-size:cover; background-position: center;" />
                <!-- /.container-fluid -->
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Your Website 2024 BY <a
                                href="https://www.linkedin.com/in/alaa-fathy-4888091b0/" target="_blank"
                                style="color: red;text-decoration: none">Alaa Fathy</a></span></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
